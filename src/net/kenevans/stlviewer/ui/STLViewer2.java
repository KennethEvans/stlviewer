 ...
 */
public class STLViewer2 extends JFrame implements IConstants
{
    /**
    ...
    public String defaultDirectory = DEFAULT_DIR;
    ...
    void findFileNames(String dirName) {
        ...
        if(!dir.exists()) {
            SWTUtils.errMsg("Does not exist: " + dirName);
            return;
        }
        if(!dir.isDirectory()) {
            SWTUtils.errMsg("Not a directory: " + dirName);
            return;
        }
    ...
    void uiInit() {
        ...
        displayPanel.setPreferredSize(new Dimension(WIDTH_2, HEIGHT_2 / 2));
        plot.createChart();
    ...
    private void initMenus() {
        ...
        menuItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ae) {
                JOptionPane.showMessageDialog(null, new AboutBoxPanel(TITLE_2,
                    "Written by Kenneth Evans, Jr.", "kenevans.net",
                    "Copyright (c) 2014 Kenneth Evans"), "About",
    ...
    public void run() {
        try {
            ...
            // Display the window
            this.setBounds(20, 20, WIDTH_2, HEIGHT_2);
    ...
    private void openDefaultDirectory() {
        ...
        if(result == JFileChooser.APPROVE_OPTION) {
            ...
            if(!dir.isDirectory()) {
                SWTUtils.errMsg("Not a diretory: " + dirName);
                return;
            }
    ...
    private void onListItemSelected(ListSelectionEvent ev) {
        ...
        if(!file.exists()) {
            SWTUtils.errMsg("Does not exist: " + fileName);
            return;
        }
    ...
    public static void main(String[] args) {
        final STLViewer2 app = new STLViewer2();
